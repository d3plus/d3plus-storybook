...
Since Next.js using server-side generation, you need to wrap your components in a dynamic import block. The following is a simple example to illustrate the point:
...
...and your `treemapCountries` component then imports the required d3plus module normally.
